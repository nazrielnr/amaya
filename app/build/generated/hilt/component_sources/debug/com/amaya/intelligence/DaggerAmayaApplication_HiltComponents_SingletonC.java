...
import com.amaya.intelligence.tools.ApplyDiffTool;
import com.amaya.intelligence.tools.BatchReadTool;
import com.amaya.intelligence.tools.CopyFileTool;
...
public final class DaggerAmayaApplication_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends AmayaApplication_HiltComponents.SingletonC {
    ...
    private Provider<CopyFileTool> copyFileToolProvider;

    private Provider<MoveFileTool> moveFileToolProvider;

    private Provider<SearchFilesTool> searchFilesToolProvider;

    private Provider<EditFileTool> editFileToolProvider;

    private Provider<GetFileInfoTool> getFileInfoToolProvider;

    private Provider<FindFilesTool> findFilesToolProvider;

    private Provider<UndoChangeTool> undoChangeToolProvider;

    private Provider<BatchReadTool> batchReadToolProvider;

    private Provider<ApplyDiffTool> applyDiffToolProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.copyFileToolProvider = DoubleCheck.provider(new SwitchingProvider<CopyFileTool>(singletonCImpl, 20));
      this.moveFileToolProvider = DoubleCheck.provider(new SwitchingProvider<MoveFileTool>(singletonCImpl, 21));
      this.searchFilesToolProvider = DoubleCheck.provider(new SwitchingProvider<SearchFilesTool>(singletonCImpl, 22));
      this.editFileToolProvider = DoubleCheck.provider(new SwitchingProvider<EditFileTool>(singletonCImpl, 23));
      this.getFileInfoToolProvider = DoubleCheck.provider(new SwitchingProvider<GetFileInfoTool>(singletonCImpl, 24));
      this.findFilesToolProvider = DoubleCheck.provider(new SwitchingProvider<FindFilesTool>(singletonCImpl, 25));
      this.undoChangeToolProvider = DoubleCheck.provider(new SwitchingProvider<UndoChangeTool>(singletonCImpl, 26));
      this.batchReadToolProvider = DoubleCheck.provider(new SwitchingProvider<BatchReadTool>(singletonCImpl, 27));
    }

    @SuppressWarnings("unchecked")
    private void initialize2(final ApplicationContextModule applicationContextModuleParam) {
      this.applyDiffToolProvider = DoubleCheck.provider(new SwitchingProvider<ApplyDiffTool>(singletonCImpl, 28));
      this.createReminderToolProvider = DoubleCheck.provider(new SwitchingProvider<CreateReminderTool>(singletonCImpl, 29));
      this.personaRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<PersonaRepository>(singletonCImpl, 31));
      this.updateMemoryToolProvider = DoubleCheck.provider(new SwitchingProvider<UpdateMemoryTool>(singletonCImpl, 30));
      this.todoRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<TodoRepository>(singletonCImpl, 33));
      this.updateTodoToolProvider = DoubleCheck.provider(new SwitchingProvider<UpdateTodoTool>(singletonCImpl, 32));
      this.toolExecutorProvider = new DelegateFactory<>();
      this.subagentRunnerProvider = DoubleCheck.provider(new SwitchingProvider<SubagentRunner>(singletonCImpl, 35));
      this.invokeSubagentsToolProvider = DoubleCheck.provider(new SwitchingProvider<InvokeSubagentsTool>(singletonCImpl, 34));
      ...
      this.mcpClientManagerProvider = DoubleCheck.provider(new SwitchingProvider<McpClientManager>(singletonCImpl, 37));
      this.mcpToolExecutorProvider = DoubleCheck.provider(new SwitchingProvider<McpToolExecutor>(singletonCImpl, 36));
      this.provideProjectDaoProvider = DoubleCheck.provider(new SwitchingProvider<ProjectDao>(singletonCImpl, 39));
      this.provideFileDaoProvider = DoubleCheck.provider(new SwitchingProvider<FileDao>(singletonCImpl, 40));
      this.provideFileMetadataDaoProvider = DoubleCheck.provider(new SwitchingProvider<FileMetadataDao>(singletonCImpl, 41));
      this.fileIndexRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<FileIndexRepository>(singletonCImpl, 38));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new ToolExecutor(singletonCImpl.listFilesToolProvider.get(), singletonCImpl.readFileToolProvider.get(), singletonCImpl.writeFileToolProvider.get(), singletonCImpl.createDirectoryToolProvider.get(), singletonCImpl.deleteFileToolProvider.get(), singletonCImpl.runShellToolProvider.get(), singletonCImpl.copyFileToolProvider.get(), singletonCImpl.moveFileToolProvider.get(), singletonCImpl.searchFilesToolProvider.get(), singletonCImpl.editFileToolProvider.get(), singletonCImpl.getFileInfoToolProvider.get(), singletonCImpl.findFilesToolProvider.get(), singletonCImpl.undoChangeToolProvider.get(), singletonCImpl.batchReadToolProvider.get(), singletonCImpl.applyDiffToolProvider.get(), singletonCImpl.createReminderToolProvider.get(), singletonCImpl.updateMemoryToolProvider.get(), singletonCImpl.updateTodoToolProvider.get(), singletonCImpl.invokeSubagentsToolProvider.get(), singletonCImpl.commandValidatorProvider.get());
          ...
          case 20: // com.amaya.intelligence.tools.CopyFileTool 
          return (T) new CopyFileTool(singletonCImpl.commandValidatorProvider.get());

          case 21: // com.amaya.intelligence.tools.MoveFileTool 
          return (T) new MoveFileTool(singletonCImpl.commandValidatorProvider.get());

          case 22: // com.amaya.intelligence.tools.SearchFilesTool 
          return (T) new SearchFilesTool(singletonCImpl.commandValidatorProvider.get());

          case 23: // com.amaya.intelligence.tools.EditFileTool 
          ...
          case 24: // com.amaya.intelligence.tools.GetFileInfoTool 
          return (T) new GetFileInfoTool(singletonCImpl.commandValidatorProvider.get());

          case 25: // com.amaya.intelligence.tools.FindFilesTool 
          return (T) new FindFilesTool(singletonCImpl.commandValidatorProvider.get());

          case 26: // com.amaya.intelligence.tools.UndoChangeTool 
          return (T) new UndoChangeTool(singletonCImpl.commandValidatorProvider.get());

          case 27: // com.amaya.intelligence.tools.BatchReadTool 
          return (T) new BatchReadTool(singletonCImpl.commandValidatorProvider.get());

          case 28: // com.amaya.intelligence.tools.ApplyDiffTool 
          return (T) new ApplyDiffTool(singletonCImpl.commandValidatorProvider.get());

          case 29: // com.amaya.intelligence.tools.CreateReminderTool 
          ...
          case 30: // com.amaya.intelligence.tools.UpdateMemoryTool 
          ...
          case 31: // com.amaya.intelligence.data.repository.PersonaRepository 
          ...
          case 32: // com.amaya.intelligence.tools.UpdateTodoTool 
          return (T) new UpdateTodoTool(singletonCImpl.todoRepositoryProvider.get());

          case 33: // com.amaya.intelligence.tools.TodoRepository 
          return (T) new TodoRepository();

          case 34: // com.amaya.intelligence.tools.InvokeSubagentsTool 
          return (T) new InvokeSubagentsTool(singletonCImpl.subagentRunnerProvider.get());

          case 35: // com.amaya.intelligence.tools.SubagentRunner 
          ...
          case 36: // com.amaya.intelligence.data.remote.mcp.McpToolExecutor 
          return (T) new McpToolExecutor(singletonCImpl.toolExecutorProvider.get(), singletonCImpl.mcpClientManagerProvider.get());

          case 37: // com.amaya.intelligence.data.remote.mcp.McpClientManager 
          ...
          case 38: // com.amaya.intelligence.data.repository.FileIndexRepository 
