...
public class GeminiPropertySchemaJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<GeminiPropertySchema>() {
  ...
  @Volatile
  private var constructorRef: Constructor<GeminiPropertySchema>? = null

  override fun toString(): String = buildString(42) {
      append("GeneratedJsonAdapter(").append("GeminiPropertySchema").append(')') }

  override fun fromJson(reader: JsonReader): GeminiPropertySchema {
    ...
    if (mask0 == 0xfffffffb.toInt()) {
      ...
      val localConstructor: Constructor<GeminiPropertySchema> = this.constructorRef ?:
          GeminiPropertySchema::class.java.getDeclaredConstructor(String::class.java,
  ...
  override fun toJson(writer: JsonWriter, value_: GeminiPropertySchema?) {
    if (value_ == null) {
