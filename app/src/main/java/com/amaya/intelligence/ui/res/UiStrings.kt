...
object UiStrings {
    ...
    object Placeholders {
        ...
        const val AGENT_NAME_EXAMPLE = "e.g. My GPT-4o"
        const val MODEL_ID_EXAMPLE = "e.g. gpt-4o, claude-sonnet-4-20250514"
        const val API_KEY_EXAMPLE = "sk-... (leave blank if not needed)"
        const val BASE_URL_EXAMPLE = "https://openrouter.ai/api/v1"
        const val MAX_TOKENS_EXAMPLE = "8192"
        const val SERVER_URL_EXAMPLE = "https://mcp.example.com/mcp"
