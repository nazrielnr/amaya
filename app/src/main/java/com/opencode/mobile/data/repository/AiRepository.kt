...
import com.opencode.mobile.data.remote.api.*
import com.opencode.mobile.tools.ConfirmationRequest
import com.opencode.mobile.tools.ToolDefinition
import com.opencode.mobile.tools.ToolExecutor
import com.opencode.mobile.tools.ToolResult
...
class AiRepository @Inject constructor(
    ...
    fun chat(
        ...
        val systemPrompt = buildSystemPrompt(projectId, workspacePath)
     ...
     * Build system prompt with project context.
     */
    private suspend fun buildSystemPrompt(projectId: Long?, workspacePath: String?): String {
